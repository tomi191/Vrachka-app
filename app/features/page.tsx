...
const features = [
  ...
  {
    icon: Brain,
    title: 'Таро Четения с AI',
    description: 'Открий себе си чрез таро четения интерпретирани от AI. Избери измежду различни начини на гадаене за различни житейски ситуации.',
    details: [
      'Подредби с 3 карти, 5 карти и Келтски кръст',
  ...
  {
    icon: Heart,
    title: 'Синастрия - Астрологична Съвместимост',
    description: 'Открий астрологичната съвместимост с партньор. AI анализира аспектите между двете натални карти и дава детайлна оценка на връзката.',
    details: [
  ...
  {
    icon: TrendingUp,
    title: 'Личен Хороскоп (Транзити)',
    description: 'Персонализирани месечни и годишни прогнози базирани на твоята натална карта и текущите планетни движения. AI анализира транзитите и тяхното влияние.',
    details: [
      'Месечни и годишни прогнози',
      'Анализ на кариера, любов, здраве, финанси',
      'Важни дати и периоди',
