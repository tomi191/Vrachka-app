...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: ['/api/og?title=Безплатно Таро Гадаене с AI&description=78 карти, множество разклади'],
  },
  alternates: {
    canonical: '/tarot',
  },
...
const faqData = [
  {
    ...
    answer: 'Безплатните потребители могат да изтеглят 1 карта на деня. Basic абонатите - 5 четения дневно, а Ultimate потребителите имат неограничен достъп до всички разклади.',
  },
  {
          ...
          <div className="max-w-6xl mx-auto space-y-24 mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
              ...
              <div className="prose prose-invert max-w-none text-zinc-300">
                ...
                <p>
                  Всяка карта носи уникална символика и значение, като комбинацията им в разклада разкрива дълбоки прозрения за миналото, настоящето и бъдещето. Таро не предсказва фиксирано бъдеще, а осветява възможности, предизвикателства и пътища за развитие. Във Врачка, ние уважаваме тази древна традиция и я правим достъпна за вас в дигитален формат.
                </p>
              </div>
            </div>
