...
export const metadata: Metadata = {
  title: 'Създай Натална Карта | Vrachka',
  description: 'Създай детайлна натална карта с AI интерпретация.',
};

export default async function NatalChartCreatePage() {
  ...
  if (!user) {
    redirect('/auth/login?redirect=/natal-chart-create');
  }
        ...
        <div className="glass-card p-8 text-center">
          <div className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-zinc-50 mb-2">
              Натална карта е Ultimate функция
            </h2>
            <p className="text-zinc-400">
