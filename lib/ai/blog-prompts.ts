...
TABLE OF CONTENTS (ЗАДЪЛЖИТЕЛНО):
• Вмъкни <!-- TOC --> marker след hero изображението (след <!-- HERO_IMAGE -->)
• TOC секцията трябва да съдържа списък с линкове към всички <h2> заглавия в статията
• Формат: <h2> с id="heading-X", <ol> списък с <li><a href="#heading-X">заглавие</a></li>
• Заглавие на секцията: "В тази статия" с подходящи стилове
• Това позволява на читателите бързо да навигират до интересуващите ги секции

ФОРМАТ НА OUTPUT:
Генерирай съдържанието в HTML format с:
- <!-- HERO_IMAGE --> в началото
- <!-- TOC --> marker след hero изображението за Table of Contents
...
ВАЖНО: Върни САМО валиден JSON обект. Не включвай обяснения или markdown.

Твоята задача е да попълниш следните полета:

{
  "title": "Кратко, SEO-оптимизирано заглавие (50-60 символа).",
  "metaTitle": "SEO мета заглавие (може да е същото като title, 50-60 символа).",
  "metaDescription": "Много важно: Напиши УНИКАЛНО, човешко звучащо мета описание (150-160 символа). Трябва да обобщава статията и да приканва към четене. Включи основната ключова дума естествено. Използвай правилен български език, словоред и граматика. НЕ ИЗПОЛЗВАЙ генерични фрази като 'Генерирана статия'.",
  "excerpt": "Кратко резюме за превюта (150-200 символа). Може да е първият параграф или специално написано резюме.",
  "content": "Пълното HTML съдържание на статията, както е дефинирано по-горе.",
  "keywords": "Много важно: Генерирай масив от 7-10 релевантни ключови думи. Включи основната дума, вторични думи и long-tail варианти, които са специфични за съдържанието на статията. Не използвай просто подадените ти ключови думи, а ги разшири."
}
